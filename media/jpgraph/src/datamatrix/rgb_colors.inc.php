<?php
/*=======================================================================
// File: 	RGB_COLORS.INC.PHP
// Description:	Symbolic definition for color names and methods to
//              create RGB triplets.
// Created: 	2006-09-01
// Ver:		$Id: rgb_colors.inc.php 988 2008-03-25 02:50:13Z ljp $
//
...
class Datamatrix_RGB {
    private $iRGBtable;

    function Datamatrix_RGB() {
	// Conversion array between color names and RGB
	$this->iRGBtable = array(
...
// PUBLIC METHODS
	...
	if (is_string($aColor)) {
		...
		$b = hexdec(substr($aColor, 5, 2));
      		...
      		if(!isset($this->iRGBtable[$aColor]) ) {
		    return false;
		}
		$tmp=$this->iRGBtable[$aColor];
		$r = $tmp[0];
		$g = $tmp[1];
		$b = $tmp[2];
	    }
