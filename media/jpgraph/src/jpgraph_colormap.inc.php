...
//
// Created:     2009-07-10
// Ver:         $Id: jpgraph_colormap.inc.php 1800 2009-09-08 10:43:38Z ljp $
//
...
class ColorMap {
    ...
    private $inullcolor = array(196,196,196);
    ...
    public function getColor($aVal) {
        $this->chk();
    	if( $aVal==="" || is_nan($aVal) || is_null($aVal) ) {
    ...
    private function InitBuckets() {
        ...
        // Make sure the NULL color is an array and not a color string
        $this->inullcolor =  $this->rgb->Color($this->inullcolor);
